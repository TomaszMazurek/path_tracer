...
class moving_sphere : public object3d {
    public:
        moving_sphere() {}
        moving_sphere(
...
bool moving_sphere::hit(const ray& r, double t_min, double t_max, ray_hit_point& hit) const {
    ...
    hit.t = root;
    hit.p = r.at(hit.t);
    auto outward_normal = (hit.p - center(r.time())) / radius;
